                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input2" name="tel" placeholder="Telefon" value="{if $oClient->tel}{$oClient->tel}{/if}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input5" class="col-sm-2 control-label">Město</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input5" name="address1" placeholder="Město" value="{if $oClient->address1}{$oClient->address1}{/if}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input7" class="col-sm-2 control-label">PSČ</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input7" name="postalCode" placeholder="PSČ" value="{if $oClient->postalCode}{$oClient->postalCode}{/if}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="input4" name="email" placeholder="Email"  value="{if $oClient->email}{$oClient->email}{/if}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input6" class="col-sm-2 control-label">Ulice</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input6" name="address2" placeholder="Ulice" value="{if $oClient->address2}{$oClient->address2}{/if}">
                                </div>
                            </div>
                        </div>
                    </div>
