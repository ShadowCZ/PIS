                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required title="Toto pole je potřeba vyplnit." type="text" class="form-control" id="input8" name="login" placeholder="Login" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                {*
                                <div class="col-sm-10">
                                    <input required title="Toto pole je potřeba vyplnit." type="text" class="form-control" id="input9" name="role" placeholder="Role" value="">
                                </div>
                                *}
                                <div class="col-sm-10">
